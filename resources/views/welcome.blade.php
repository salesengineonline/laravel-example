...
$ git push</pre>
                  ...
                  <p>
                  To add REST and DB connectivity to this sample app, you can update the application to launch using the code made available via this repository.  Rename <code>config.ru</code> and <code>rails.ru</code> like so:
<pre>$ mv config.ru config.ru.sample
$ mv rails.ru config.ru
$ git commit -a -m 'Some commit message'
$ git push</pre>
                  </p>
                  <p>
...
osc env dc/frontend POSTGRESQL_PASSWORD=&lt;your database user's password&gt;</pre>
          ...
          <section class="col-xs-12 col-sm-6 col-md-6">
                ...
                <ul>
                	<li>Laravel project created with python manage.py startproject project <code>laravel new new-app</code></li>
